        ...
        <div class="card-content">
          <div class="card-body text-center">
            ...
            <div class="text-center">
              <h1 class="mb-2 text-white">Welcome, {{Auth::user()->role}}</h1>
              <p class="m-auto w-75">You have elvated permission to oversea administrative proceedings</p>
            </div>
          </div>
        </div>
      </div>

                          ...
                          <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="{{$personal_data->state??''}}" selected="selected" > {{$personal_data->state??'- Select State of Origin -'}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="{{$personal_data->lga??''}}" selected="selected" > {{$personal_data->lga??'- Select LGA -'}}</option>

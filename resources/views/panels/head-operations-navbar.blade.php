        ...
        <div class="navbar-collapse" id="navbar-mobile">
          <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
            ...
            <ul class="nav navbar-nav bookmark-icons">
              <li class="nav-item d-none d-lg-block">
                  <h4 class="text-center">Dashboard: Head of Operations</h4>
            ...
            <ul class="nav navbar-nav">
              <li class="nav-item d-none d-lg-block">
                ...
                <div class="bookmark-input search-input">
                  ...
                  <input class="form-control input" type="text" placeholder="Explore Profile..." tabindex="0"
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#"
                ...
                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">{{Auth::user()->firstname}}
                {{Auth::user()->surname}}</span><span class="user-status">{{Auth::user()->ippis_no}}</span></div><span><img class="round"
                    src="{{asset('images/uploads_placeholder/passport.jpg') }}" alt="avatar" height="40"
                    width="40" /></span>
              </a>
